                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.update',$pro->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-pament" name="name" value="{{$pro->name}}"  type="text" class="form-control" aria-required="true" aria-invalid="false">
                                </div>
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">Product Price</label>
                                    <input id="cc-pament" name="price" value="{{$pro->price}}" type="number" class="form-control" aria-required="true" aria-invalid="false">
                                </div>
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">Brand name</label>
                                    <input id="cc-pament" name="brand" value="{{$pro->brand}}" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                </div>
                                <div class="form-group">
                                    <label for="cc-payment" class="control-label mb-1">Category</label>
                                    <select class="form-control" name="cetegory">
                                        <option>----------</option>
                                        <option value="{{$pro->cetegory}}" selected disabled aria-readonly="true">{{$pro->cetegory}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="/image/{{$pro->image}}" height="80px" width="80px">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="dis" id="cc-pament">{{$pro->dis}}</textarea>
                                </div>

                                <div>
                                    <button id="payment-button"type="submit" class="btn btn-lg btn-info btn-block">
                                        <span id="payment-button-amount">Edit Product</span>
                                    </button>
                                </div>
                            </form>
                        </div>
